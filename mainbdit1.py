...
def print_stats():
    ...
    print(
        f"    ├─ Bangla (classified): "
        f"{STATS['total_bangla']}"
    )

    print(
        f"    └─ Non-Bangla (skipped): "
        f"{STATS['total_skipped_non_bangla']}"
    )
...
def main():
    ...
    print(
        f"Classifying {len(bangla_articles)} "
        f"Bangla article(s)..."
    )
